...
var import_array_reduce_prototypejs_fix = __toESM(require("array-reduce-prototypejs-fix"));
class params_default extends import_url_part.default {
  ...
  test(content = "", patterns = this.pattern) {
    ...
    if ((0, import_exists.default)(patterns)) {
      ...
      result = (0, import_array_reduce_prototypejs_fix.default)(patterns, (previous_result, pattern) => {
      ...
      if (this.is_strict === true) {
        if (typeof content === "string") {
          ...
          result = (0, import_array_reduce_prototypejs_fix.default)(content.split("&"), (previous_result, pair) => {
